...
nin = Nss+1;
nit = round(800/Ts) + nin; % número de iterações da simulação
...
refs(nin+round(50/Ts):end) = -0.05+Cobar;
refs(nin+round(200/Ts):end) = 0.1+Cobar;
refs(nin+round(400/Ts):end) = 0.05+Cobar;
refs(nin+round(600/Ts):end) =+Cobar;


perts(1,nin+round(200/Ts):end) = 0;
