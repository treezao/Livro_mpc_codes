    ...
    for i=1:n
        ...
        for j=1:m
            ...
            str1 = numR{i}{j}*(entradas(j,k-atrasoEntrada(i,j):-1:k+1-sizeN-atrasoEntrada(i,j))'...
                               +perts(j,k-atrasoEntrada(i,j):-1:k+1-sizeN-atrasoEntrada(i,j))');
...
% print('fracionador_gpc_dtc_final_ref','-depsc')
...
% hf.Position = tamfigura;
hl.Position = [0.3297 0.4913 0.2179 0.1750];


% print('fracionador_gpc_dtc_final_q','-depsc')