...
% print('dtc_nlin_pnmpc_plucenio_psf_final','-depsc')
...
ax = get(gcf,'children');
ind2 = find(isgraphics(ax,'Legend'));
set(gcf,'children',ax([ind2:end,1:ind2-1]))


hl.Position = [0.6542 0.3669 0.3321 0.2758];



% print('dtc_nlin_pnmpc_plucenio_psf_final_q','-depsc')
